...
namespace lab3 {
  ...
  public:
    Sorcerer(string name, string description) {_name=name;
        _description=description; _health = balance::_classes_health["Sorcerer"];
        _max_health = _health; _spells = &_sorcerer_spells;}
    virtual ~Sorcerer() {}
  private:
